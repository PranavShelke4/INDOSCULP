    ...
    return (
        ...
        <div className='info'>
            ...
            {/* <div className='tabs'>
                ...
                <button class="tablinks" onclick="openTab(event, 'Sales_And_Distributors')">
                ...
                <button class="tablinks" onclick="openTab(event, 'Contact_request')">
                ...
                <button class="tablinks" onclick="openTab(event, 'Our_location')">
            ...
            <div id="Sales_And_Distributors" class="tabcontent">
            <h3>London</h3>
