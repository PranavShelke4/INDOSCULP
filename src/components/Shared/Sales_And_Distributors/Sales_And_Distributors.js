    ...
    return (
        <Container>
            ...
            <div className='person_info'>
                ...
                <p id='address'>AC 7 - AC 11 Sidco Industrial Estate Thirumudivakkam Chennai - 600 044</p><br/>
                <p id='Functions'><b>FUNCTION:</b> Aftersales, Assembly, Manufacturing, Sales <br/> <b>BUSINESS AREA:</b> Mobile, Wind</p>
                <hr/>
                <p id='number'>
